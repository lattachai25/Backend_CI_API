...
<!-- Our Concept -->    
    <div class="row" style="background:#f5f5f5;">
      <img src="<?php base_url();?>img/home/MPK_Design_001_OK_150820_1A_create_10.png" width="100%" alt=""/>
    <div class="col-12">
        <div class="row" style="margin-top:80px; margin-bottom:80px;">
            ...
            <div class="col-8">
                <div class="row">
                    <div class="col-3">
                        <div class="row">
                            <div class="col-5"><img src="<?php base_url();?>img/home/back_icon/BestQuality.png" width="50px" alt=""></div>
                            <div class="col-7 text4">BEST <br> QUALITY</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="row">
                            <div class="col-5"><img src="<?php base_url();?>img/home/back_icon/Service.png" width="50px" alt=""></div>
                            <div class="col-7 text4">EXPERTISE <br> SERVICE</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="row">
                            <div class="col-5"><img src="<?php base_url();?>img/home/back_icon/Guarantee.png" width="50px" alt=""></div>
                            <div class="col-7 text4">AUTHENTIC <br> GUARANTEE</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="row">
                            <div class="col-5"><img src="<?php base_url();?>img/home/back_icon/SH_01.png" width="50px" alt=""></div>
    ...
    <div class="row play_vdo">
        ...
        <div class="col-6">
            <div class="row">
                ...
                <center>
                PLAY
                <img src="<?php base_url();?>img/home/Play_icon.png" width="100px;"/>                
                </center>
...
<div class="col-12" style="position:relative; margin-top:-150px;">
 <img src="<?php base_url();?>img/home/carbar.png" width="100%"/>
    <div class="row bgcar">
            <!-- ROW BOX -->
        <div class="col-1"></div>
        <div class="col-10">
                ...
                <div class="row">
                    <div style="border:3px solid #e8e8e8; width:420px; height:450px; backgrount-color:#fff;">
                        <div class="container2">
                            <center>
                                <img src="<?php base_url();?>/img/home/1/<?php echo ".$i." ?>.jpg" width="120%" style="margin-left:10%;" />
                            </center>
                            <div class="overlay">
        ...
        <br>
        <center>
        <img src="<?php base_url();?>img/home/poit.png" alt="">
        </center>
        </div>
    </div>
    <!-- ROW BOX -->
...
<div class="col-12" style="min-height:700px;">
    <img src="<?php base_url();?>img/home/MPK_Design_001_OK_150820_1A_create_16.png" width="100%" alt=""/>
            ...
            <div class="col-3">
                <div class="row">
                    <div style="border:3px solid #e8e8e8; margin:10px; height:400px; backgrount-color:#fff;">
                        <img src="<?php base_url();?>img/home/2/'.$i.'.png" width="100%" />
...
<!-- Best Seller -->
<div class="row">
    <img src="<?php base_url();?>img/home/MPK_Design_001_OK_150820_1A_create_12.png" width="98%" alt=""/>
</div>
<!-- Best Seller -->
<!-- bike for sell -->
<div class="col-12">
    <div class="top" style="min-height:900px; background-color:#000;">
    <img src="<?php base_url();?>img/home/MPK_Design_001_OK_150820_1A_create_19.png" width="100%" alt=""/>

        <div class="row">
            <div class="col-1"></div>
            <div class="col-11">
                <div id="owl-demo" class="owl-carousel owl-theme">
                <div class="item"><img src="<?php base_url();?>img/product/bike/01-1.png" width="100%" /></div>
                <div class="item"><img src="<?php base_url();?>img/product/bike/Bike_02.png" width="100%" /></div>
                <div class="item"><img src="<?php base_url();?>img/product/bike/Bike_03.png" width="100%" /></div>
                <div class="item"><img src="<?php base_url();?>img/product/bike/Bike_04.png" width="100%" /></div>
                </div>
            </div>
            <div class="col-2"></div>
            <div class="col-6" style="font-size:20px; font-weight:bold; color:#fff;">
            &nbsp; &nbsp;   01/05<br>
            <img src="<?php base_url();?>img/product/bike/barslide_top.png" width="50%" />
            </div>
        </div>
...
<!-- bike for sell -->
<div class="row">
<img src="<?php base_url();?>img/home/MPK_Design_001_OK_150820_1A_create_21.png" width="98%" alt=""/>
</div>
